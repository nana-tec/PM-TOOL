...
export default function ProjectsSummary({ items }) {
  ...
  const scheme =
    theme.colorScheme || (document?.documentElement?.dataset?.mantineColorScheme ?? 'light');
  ...
  const seriesColors = useMemo(() => {
    ...
    return names.map(
      (_, idx) =>
        theme.colors?.[palettes[idx % palettes.length]]?.[shadeStrong] ||
        theme.colors.blue[shadeStrong]
    );
  ...
  return (
    ...
    >
      ...
      >
        <ChartCard
          title='Tasks distribution by project'
          subtitle='How many tasks each project contains'
        >
        ...
        <ChartCard
          ...
          subtitle='Projects with most issues'
        >
          <div style={{ height: 280 }}>
            <Bar
        ...
        <ChartCard
          ...
          subtitle='Which projects are moving fastest'
        >
          <div style={{ height: 280 }}>
            <Bar
              data={completionRateByProject}
              options={{
                ...commonOptions,
      ...
      <ChartCard
        ...
        subtitle='Completed, overdue and remaining'
      >
        <div style={{ height: 360 }}>
          <Bar
            data={compositionStacked}
