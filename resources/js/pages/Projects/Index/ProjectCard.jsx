...
export default function ProjectCard({ item, linkTo = 'auto' }) {
  const completedPercent =
    item.all_tasks_count > 0 ? (item.completed_tasks_count / item.all_tasks_count) * 100 : 0;
  const overduePercent =
    item.all_tasks_count > 0 ? (item.overdue_tasks_count / item.all_tasks_count) * 100 : 0;
