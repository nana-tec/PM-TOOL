    ...
    <div className={classes.childrenWrapper}>
      <Card
        ...
        style={{
          cursor: 'pointer',
          borderLeft:
            depth > 0 ? `3px solid var(--mantine-color-blue-${Math.min(4 + depth, 9)})` : undefined,
        }}
      >
        <Group
        ...
        >
          ...
          >
            ...
            >
              <Text
                ...
                size='sm'
                lineClamp={1}
                onClick={() => redirectTo('projects.open', node.id)}
          ...
          >
            ...
            <Tooltip
              label={`${completedPercent}% complete (${node.completed_tasks_count || 0}/${node.all_tasks_count || 0})`}
            >
              <Stack
                gap={2}
                style={{ minWidth: 80 }}
              >
                ...
                <Progress
                  ...
                  radius='xl'
                  color={
                    completedPercent >= 80 ? 'green' : completedPercent >= 40 ? 'blue' : 'gray'
                  }
                />
              </Stack>
            </Tooltip>
            <Button
              size='xs'
              variant='light'
              onClick={() => redirectTo('projects.tasks', node.id)}
            >
              Tasks
            </Button>
          </Group>
