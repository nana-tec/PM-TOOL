...
export default function VcsDashboard({ projectId }) {
  ...
  return (
    <Stack gap='md'>
      ...
      >
        <Stack gap={0}>
          ...
          <Text
            ...
            c='dimmed'
          >
            Top committers are always from the default branch ({data.default_branch})
          </Text>
        </Stack>
        <Group>
          <Tooltip label={`Default: ${data.default_branch}`}>
            <Badge variant='light'>Branch: {selectedBranch || data.branch}</Badge>
          </Tooltip>
          <Select
      ...
      >
        <ChartCard
          title='PR activity by day'
          subtitle='Opened vs Merged'
        >
        ...
        <ChartCard
          title='PR activity by week'
          subtitle='Opened vs Merged (ISO weeks)'
        >
          <div style={{ height: 260 }}>
              ...
              >
                ...
                >
                  ...
                  <Text
                    ...
                    c='dimmed'
                  >
                    {c.sha?.slice(0, 7)} · {c.author || 'Unknown'} ·{' '}
              ...
              >
                ...
                >
                  ...
                  <Badge
                    size='xs'
                    variant='light'
                    color={p.state === 'merged' ? 'blue' : p.state === 'open' ? 'green' : 'gray'}
                  >
                    {p.state}
                  </Badge>
                </Stack>
