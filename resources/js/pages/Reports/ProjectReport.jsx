...
import { IconFolder, IconChevronDown, IconChevronRight, IconSubtask } from '@tabler/icons-react';
          ...
          <>
            <Table.ScrollContainer minWidth={1200}>
              ...
              >
                ...
                <Table.Tbody>
                  {projects
                    .slice((projectPage - 1) * PROJECTS_PER_PAGE, projectPage * PROJECTS_PER_PAGE)
                    .map(proj => {
                          ...
                          >
                                ...
                                <Stack gap={2}>
                                  <Group gap='xs'>
                                    ...
                                    {proj.sub_projects && proj.sub_projects.length > 0 && (
                                      <Tooltip
                                        label={`Includes ${proj.sub_projects.length} sub-project${proj.sub_projects.length > 1 ? 's' : ''}: ${proj.sub_projects.map(sp => sp.name).join(', ')}`}
                                      >
                                        <Badge
                                          size='xs'
                                          variant='light'
                            ...
                            <Table.Td>
                              {proj.nearest_due ? (
                                <Badge
                                  variant='light'
                                  color={dayjs(proj.nearest_due).isBefore(dayjs()) ? 'red' : 'blue'}
                                >
                                ...
                                <>
                                  ...
                                  >
                                    ...
                                    <Table.Tbody>
                                      {tasks
                                        .slice(
                                          ((taskPages[proj.project.id] || 1) - 1) * ITEMS_PER_PAGE,
                                          (taskPages[proj.project.id] || 1) * ITEMS_PER_PAGE
                                        )
                                        .map(t => (
                                          <Table.Tr key={t.id}>
                                            <Table.Td>
                                  ...
                                  {tasks.length > ITEMS_PER_PAGE && (
                                    ...
                                    >
                                      ...
                                      <Pagination
                                        ...
                                        value={taskPages[proj.project.id] || 1}
                                        onChange={p =>
                                          setTaskPages(prev => ({ ...prev, [proj.project.id]: p }))
                                        }
                                      />
                                    </Group>
                                  )}
                                ...
                                <>
                                  ...
                                  >
                                    ...
                                    <Table.Tbody>
                                      {subtasks
                                        .slice(
                                          ((subPages[proj.project.id] || 1) - 1) * ITEMS_PER_PAGE,
                                          (subPages[proj.project.id] || 1) * ITEMS_PER_PAGE
                                        )
                                        .map(s => (
                                          <Table.Tr key={s.id}>
                                            <Table.Td>
                                  ...
                                  {subtasks.length > ITEMS_PER_PAGE && (
                                    ...
                                    >
                                      ...
                                      <Pagination
                                        ...
                                        value={subPages[proj.project.id] || 1}
                                        onChange={p =>
                                          setSubPages(prev => ({ ...prev, [proj.project.id]: p }))
                                        }
                                      />
                                    </Group>
                                  )}
            ...
            {projects.length > PROJECTS_PER_PAGE && (
              ...
              >
                ...
                >
                  ...
                  {Math.min(projectPage * PROJECTS_PER_PAGE, projects.length)} of {projects.length}{' '}
                  projects
                </Text>
                <Pagination
                  size='sm'
                  total={Math.ceil(projects.length / PROJECTS_PER_PAGE)}
                  value={projectPage}
