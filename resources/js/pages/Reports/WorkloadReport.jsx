          ...
          <>
              ...
              >
                <Table.Thead>
                  <Table.Tr>
                    ...
                    <Table.Th>
                      <Tooltip label='Total open (tasks + subtasks)'>
                        <Text
                          size='sm'
                          fw={600}
                        >
                    ...
                    <Table.Th>
                      <Tooltip label='Overdue tasks + subtasks'>
                        <Text
                          size='sm'
                          fw={600}
                        >
                    ...
                    <Table.Th>
                      <Tooltip label='Due within 7 days'>
                        <Text
                          size='sm'
                          fw={600}
                        >
                    ...
                    <Table.Th>
                      <Tooltip label='High/urgent priority open'>
                        <Text
                          size='sm'
                          fw={600}
                        >
                    ...
                    <Table.Th>
                      <Tooltip label='Completed tasks + subtasks'>
                        <Text
                          size='sm'
                          fw={600}
                        >
                    ...
                    <Table.Th>
                      <Tooltip label='Estimated hours of open work'>
                        <Text
                          size='sm'
                          fw={600}
                        >
                ...
                <Table.Tbody>
                  {members
                    .slice((memberPage - 1) * MEMBERS_PER_PAGE, memberPage * MEMBERS_PER_PAGE)
                    .map(member => {
                      ...
                      return (
                        <>
                          ...
                          >
                            ...
                            <Table.Td>
                              <Text fw={500}>{member.open_tasks}</Text>
                            </Table.Td>
                            <Table.Td>
                              <Text fw={500}>{member.open_subtasks}</Text>
                            </Table.Td>
                            <Table.Td>
                              <WorkloadBar
                                value={member.total_open}
                                max={maxOpen}
                                color={wColor}
                              />
                            </Table.Td>
                            ...
                            <Table.Td>
                              <Text fw={500}>{member.time_logged}h</Text>
                            </Table.Td>
                            <Table.Td>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <Group gap={4}>
                                  <IconFolder size={16} /> Project breakdown
                                </Group>
                              </Text>
                              {!member.project_breakdown ||
                              member.project_breakdown.length === 0 ? (
                                <Text
                                  c='dimmed'
                                  size='sm'
                                >
                                  ...
                                  <Table.Tbody>
                                    {member.project_breakdown.map(pb => (
                                      <Table.Tr key={pb.project_id}>
                                        ...
                                        <Table.Td>
                                          <Text size='sm'>{pb.open_hours}h</Text>
                                        </Table.Td>
                                      </Table.Tr>
                                    ))}
                                  </Table.Tbody>
            ...
            {members.length > MEMBERS_PER_PAGE && (
              ...
              >
                ...
                <Pagination
                  size='sm'
                  total={Math.ceil(members.length / MEMBERS_PER_PAGE)}
                  value={memberPage}
