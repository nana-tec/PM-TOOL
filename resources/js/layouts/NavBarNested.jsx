  ...
  useEffect(() => {
    setItems([
      ...
      },
      {
        ...
        visible:
          can('view logged time sum report') ||
          can('view daily logged time report') ||
          can('view fixed price sum report') ||
          can('view team capacity report'),
        links: [
          {
          ...
          {
            label: 'Member report',
            link: route('reports.member-report'),
            active: route().current('reports.member-report'),
            visible: can('view team capacity report'),
          },
          {
            label: 'Project report',
            link: route('reports.project-report'),
            active: route().current('reports.project-report'),
            visible: can('view team capacity report'),
          },
          {
            label: 'Workload report',
            link: route('reports.workload-report'),
            active: route().current('reports.workload-report'),
            visible: can('view team capacity report'),
          },
        ],
      },
